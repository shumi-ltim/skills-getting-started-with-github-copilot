...
activities = {
    ...
    "Drama Club": {
        "description": "Theater rehearsals, play production, and performance practice",
    ...
    # Intellectual (added)
    "Math Olympiad": {
        "description": "Problem solving, contest prep, and math team practice",
        "schedule": "Saturdays, 10:00 AM - 12:00 PM",
        "max_participants": 25,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, projects, and STEM activities",
